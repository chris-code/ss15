...
def read_labeled(path, limit=None):
	...
	with open(path, 'r') as file:
		...
		for index, data_point in enumerate(csv_reader):
			...
			incident = (date, category, descript, day_of_week, pd_district, resolution, adress, latitude, longitude)
...
def read_unlabeled(path, limit=None):
	...
	with open(path, 'r') as file:
		...
		for index, data_point in enumerate(csv_reader):
			...
			incident = (date, day_of_week, pd_district, adress, latitude, longitude)
			data.append(incident)
	return data
